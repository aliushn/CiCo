...
_C.MODEL.PREDICTION_HEADS.CUBIC_SPATIOTEMPORAL_BLOCK = False
_C.MODEL.PREDICTION_HEADS.CUBIC_SPATIOTEMPORAL_CASCADED_BLOCK = False
_C.MODEL.PREDICTION_HEADS.CUBIC_CORRELATION_MODE = False
_C.MODEL.PREDICTION_HEADS.CUBIC_3D_MODE = False
_C.MODEL.PREDICTION_HEADS.USE_SPATIO_DCN = False
...
# use adjacent scales features after FPN to ensure scale invarient in video domain
_C.MODEL.PREDICTION_HEADS.USE_MULTISCALE_MIX = False
